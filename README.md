...
* **Admin Cancellation API:** ถ้า Admin อยากบังคับยกเลิกการจองของอาจารย์คนอื่น **ต้องเขียน API ยกเลิกเพิ่มเองในฝั่ง Role 2 นะคะ** เพราะ API ฝั่ง Role 1 ล็อคสิทธิ์ให้เฉพาะอาจารย์ยกเลิกของตัวเองได้เท่านั้นค่ะ
